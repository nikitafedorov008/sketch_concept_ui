...
class PaintPageWeb extends StatefulWidget {
  PaintPageWeb({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _PaintPageWebState createState() => _PaintPageWebState();
}

class _PaintPageWebState extends State<PaintPageWeb> with SingleTickerProviderStateMixin {
    ...
    return Column(
      children: [
        ...
        Container(
          ...
          color: Colors.grey,
          child: Center(child: Text('drawing zone (large view)')),
        ),
      ],
    );
  }
    ...
    return Column(
      children: [
        ...
        Container(
          ...
          width: MediaQuery.of(context).size.width / 1.05,
          color: Colors.grey,
          child: Center(child: Text('drawing zone (medium view)')),
        ),
      ],
    );
  }
    ...
    return Column(
      children: [
        ...
        Container(
          ...
          width: MediaQuery.of(context).size.width / 1.05,
          color: Colors.grey,
          child: Center(child: Text('drawing zone (small view)')),
        ),
      ],
    );
  }
